        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <select name="zhangfu0" value="<?php echo $zhangfu0 ;?>">
                    <option value="8" <?php if($zhangfu0 == 8){ echo 'selected="selected"'; } ?>>8</option>
                    <option value="11" <?php if($zhangfu0 == 11){ echo 'selected="selected"'; } ?>>11</option>
                    <option value="7" <?php if($zhangfu0 == 7){ echo 'selected="selected"'; } ?>>7</option>
                ...
                <select name="zhangfu1" value="<?php echo $zhangfu1 ;?>">
                    <option value="8" <?php if($zhangfu1 == 8){ echo 'selected="selected"'; } ?>>8</option>
                    <option value="11" <?php if($zhangfu1 == 11){ echo 'selected="selected"'; } ?>>11</option>
                    <option value="7" <?php if($zhangfu1 == 7){ echo 'selected="selected"'; } ?>>7</option>
                ...
                <select name="zhangfu2" value="<?php echo $zhangfu2 ;?>">
                    <option value="13" <?php if($zhangfu2 == 13){ echo 'selected="selected"'; } ?>>13</option>
                    <option value="14" <?php if($zhangfu2 == 14){ echo 'selected="selected"'; } ?>>14</option>
                    ...
                    <option value="20" <?php if($zhangfu2 == 20){ echo 'selected="selected"'; } ?>>20</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <select name="zhangfu3" value="<?php echo $zhangfu3 ;?>">
                    ...
                    <option value="18" <?php if($zhangfu3 == 18){ echo 'selected="selected"'; } ?>>18</option>
                    ...
                    <option value="25" <?php if($zhangfu3 == 25){ echo 'selected="selected"'; } ?>>25</option>
                </select>
                <span class="">最高价：</span>
                <select name="zuigao" value="<?php echo $zuigao ;?>">
                    ...
                    <option value="35" <?php if($zuigao == 35){ echo 'selected="selected"'; } ?>>35</option>
                    <option value="20" <?php if($zuigao == 20){ echo 'selected="selected"'; } ?>>20</option>
                    <option value="40" <?php if($zuigao == 40){ echo 'selected="selected"'; } ?>>40</option>
