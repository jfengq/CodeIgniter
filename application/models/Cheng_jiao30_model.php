...
class Cheng_jiao30_model extends CI_Model {
    ...
    {
        $query = $this->db->query('select chengjiao30.* from chengjiao30 LEFT JOIN stock ON chengjiao30.code = stock.code WHERE stock.zuixin > 7 and stock.zuixin < 50 and stock.zhangfu > -1 and chengjiao30.day0 > 0');
