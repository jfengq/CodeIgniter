...
class Cheng_jiao30_model extends CI_Model {
    ...
    {
        $query = $this->db->query('select chengjiao30.* from chengjiao30 LEFT JOIN zhangfu ON zhangfu.day0 > -1 WHERE chengjiao30.day0 > 0 and chengjiao30.code = zhangfu.code');
